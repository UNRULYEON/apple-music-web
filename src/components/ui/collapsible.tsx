...
export function CollapsiblePanel({
  ...
  return (
    <CollapsiblePrimitive.Panel
      className={cn(
        "h-(--collapsible-panel-height) overflow-hidden transition-[height] duration-(--duration-fast) ease-(--ease-smooth-out) data-ending-style:h-0 data-starting-style:h-0",
        className,
      )}
